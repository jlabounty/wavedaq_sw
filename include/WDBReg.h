...
//--------------------------------------------------------------------
   ...
   unsigned int GetDebugInputLoc(unsigned int *BitMask=0, unsigned int *BitOfs=0)
   {
      switch(this->mVersion)
      {
         case 8:
   ...
   unsigned int GetDebugOutput()
   {
      switch(this->mVersion)
      {
         ...
         default:
            throw std::invalid_argument("Function GetDebugOutput() not defined for this board version");
      };
   };
   void SetDebugOutput(unsigned int value)
   {
      switch(this->mVersion)
      {
         case 8:
         ...
         default:
            throw std::invalid_argument("Function SetDebugOutput() not defined for this board version");
      };
   };
   unsigned int GetDebugOutputLoc(unsigned int *BitMask=0, unsigned int *BitOfs=0)
   {
      switch(this->mVersion)
      {
         case 8:
         case 9:
            ...
            return 0x1004;
         default:
            throw std::invalid_argument("Function GetDebugOutputLoc() not defined for this board version");
      };
   };
