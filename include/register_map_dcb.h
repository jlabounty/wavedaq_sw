...
#define DCB_ISERDES_RCVR_PACKET_COUNT_RST_REG                    DCB_REG_RST
#define DCB_ISERDES_RCVR_PACKET_COUNT_RST_MASK                    0x00000200
#define DCB_ISERDES_RCVR_PACKET_COUNT_RST_OFS                              9
