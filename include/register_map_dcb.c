...
const dcb_reg_func_type  dcb_reg_func_list[] = {
  ...
  { dcb_hw_reg , 0 },   /* register 25 [0x0064]: LMK_0 */
  { dcb_hw_reg , 0 },   /* register 26 [0x0068]: LMK_1 */
  { dcb_hw_reg , 0 },   /* register 27 [0x006C]: LMK_2 */
  { dcb_hw_reg , 0 },   /* register 28 [0x0070]: LMK_3 */
  { dcb_hw_reg , 0 },   /* register 29 [0x0074]: LMK_4 */
  { dcb_hw_reg , 0 },   /* register 30 [0x0078]: LMK_5 */
  { dcb_hw_reg , 0 },   /* register 31 [0x007C]: LMK_6 */
  { dcb_hw_reg , 0 },   /* register 32 [0x0080]: LMK_7 */
  { dcb_hw_reg , 0 },   /* register 33 [0x0084]: LMK_8 */
  { dcb_hw_reg , 0 },   /* register 34 [0x0088]: LMK_9 */
  { dcb_hw_reg , 0 },   /* register 35 [0x008C]: LMK_11 */
  { dcb_hw_reg , 0 },   /* register 36 [0x0090]: LMK_13 */
  { dcb_hw_reg , 0 },   /* register 37 [0x0094]: LMK_14 */
  { dcb_hw_reg , 0 },   /* register 38 [0x0098]: LMK_15 */
  { dcb_hw_reg , 0 },   /* register 39 [0x009C]: TIME_LSB */
  { dcb_hw_reg , 0 },   /* register 40 [0x00A0]: TIME_MSB */
  { dcb_hw_reg , 0 },   /* register 41 [0x00A4]: TIME_LSB_SET */
  { dcb_hw_reg , 0 },   /* register 42 [0x00A8]: TIME_MSB_SET */
  { dcb_hw_reg , 0 },   /* register 43 [0x00AC]: EVENT_TX_RATE */
  { dcb_hw_reg , 0 },   /* register 44 [0x00B0]: EVENT_NR */
  { dcb_hw_reg , 0 },   /* register 45 [0x00B4]: TRG_CFG */
  { dcb_hw_reg , 0 },   /* register 46 [0x00B8]: SET_TRG_CFG */
  { dcb_hw_reg , 0 },   /* register 47 [0x00BC]: CLR_TRG_CFG */
  { dcb_hw_reg , 0 },   /* register 48 [0x00C0]: TRG_AUTO_PERIOD */
  { dcb_hw_reg , 0 },   /* register 49 [0x00C4]: TRB_INFO_STAT */
  { dcb_hw_reg , 0 },   /* register 50 [0x00C8]: TRB_INFO_LSB */
