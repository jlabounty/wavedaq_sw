/*
   ...
   Date:           December 21th, 2016

   Purpose:        Example file to read binary data saved by wds.
   ...
   and fed into channels #0 and #1. It then calculates the time difference
   between these two pulses to show the performance of the WD board
